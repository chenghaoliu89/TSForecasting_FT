...
class Trans(nn.Module):
    ...
    def __init__(self):
        ...
        self.transformer_layer = nn.TransformerEncoderLayer(d_model=args.trans_hidden_size, nhead=args.trans_n_head)
        self.transformer = nn.TransformerEncoder(self.transformer_layer, num_layers=args.trans_n_layers)
